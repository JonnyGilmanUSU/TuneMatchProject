...
const Home = () => {
    ...
    const checkAuthentication = async () => {
        try {
            // const response = await axios.get('https://tunematch2-5um2xr2p.b4a.run/spotify/check-auth');
    ...
    const onChangeHandler = (event) => {
        ...
        if (searchTerm.length > 1) {
            ...
            // const response = axios.post('https://tunematch2-5um2xr2p.b4a.run/searchSuggestions', { searchTerm })
    ...
    const searchHandler = async () => {
        setIsLoading(true);
        try {
            // const response = await axios.post('https://tunematch2-5um2xr2p.b4a.run/postSearchValue', { searchValue })
    ...
    const getStartedHandler = async () => {
        try{
            // const loginResponse = await axios.get('https://tunematch2-5um2xr2p.b4a.run/spotify/login');
