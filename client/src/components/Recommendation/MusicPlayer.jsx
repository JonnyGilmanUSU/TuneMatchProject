...
function MusicPlayer () {
  ...
  // PLAY SONG EACH TIME PAGE LOADS
    ...
    const playSong = async (trackUri) => {
      try {
        // const response = await axios.post('https://tunematch2-5um2xr2p.b4a.run/play', { trackUri });
    ...
    const likeSongHandler = async (trackId) => {
      ...
      try {
        // const response = await axios.post('https://tunematch2-5um2xr2p.b4a.run/postSearchValue', { trackId });
